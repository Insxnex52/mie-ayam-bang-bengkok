$("#messageState").on("change", (x) => {
	...
	if ($("#messageState").is(":checked")) {
		...
		$(".container").stop().animate({"backgroundColor": "#e08282"}, 2000);
		$(".somplak").stop().animate({"backgroundColor": "#e08282"}, 2000);
		$(".music").stop().animate({"backgroundColor": "#e08282"}, 2000);
		console.log("Abrindo");
	} else {
		...
		$(".music").stop().animate({"backgroundColor": "#fce4ec"}, 2000);
